 ...
 */
router.get('/stats/products', auth_1.authenticate, auth_1.isAdmin, 
// @ts-ignore - Type issues with Express 5
adminController_1.getProductSalesStats);
/**
 * @swagger
 ...
 *         description: Server error
 */
router.get('/stats/monthly', auth_1.authenticate, auth_1.isAdmin, 
// @ts-ignore - Type issues with Express 5
adminController_1.getMonthlySalesData);
/**
 * @swagger
 * /api/admin/profits:
 *   get:
 ...
 *         description: Server error
 */
router.get('/profits', auth_1.authenticate, auth_1.isAdmin, 
// @ts-ignore - Type issues with Express 5
adminController_1.getAdminProfits);
/**
 * @swagger
 ...
 *         description: Server error
 */
router.get('/profits/monthly', auth_1.authenticate, auth_1.isAdmin, 
// @ts-ignore - Type issues with Express 5
adminController_1.getMonthlyAdminProfits);
