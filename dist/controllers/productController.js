 ...
 */
const updatePurchaseShippingAddress = async (req, res) => {
    try {
...
exports.updatePurchaseShippingAddress = updatePurchaseShippingAddress;
/**
 * Add or update purchase notes
 * @route PUT /api/products/purchases/:orderId/notes
 * @access Private (Buyer or Seller)
 */
const updatePurchaseNotes = async (req, res) => {
    try {
        const { orderId } = req.params;
...
exports.updatePurchaseNotes = updatePurchaseNotes;
/**
 ...
 * @access Private (Buyer or Seller)
 */
const getPurchaseDetailsForEdit = async (req, res) => {
    try {
        const { orderId } = req.params;
        const userId = req.user.id;
        const payment = await Payment_1.default.findOne({ orderId })
...
exports.getPurchaseDetailsForEdit = getPurchaseDetailsForEdit;
