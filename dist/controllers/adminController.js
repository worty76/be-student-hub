...
exports.getMonthlyAdminProfits = exports.getAdminProfits = exports.getMonthlySalesData = exports.getProductSalesStats = void 0;
...
const getProductSalesStats = async (req, res) => {
    try {
        ...
        // Group by category
        const categorySales = filteredPayments.reduce((acc, payment) => {
        ...
        const productSales = filteredPayments.reduce((acc, payment) => {
...
exports.getProductSalesStats = getProductSalesStats;
// Get monthly sales data for charts
const getMonthlySalesData = async (req, res) => {
    try {
        const { year } = req.query;
        const targetYear = year ? parseInt(year) : new Date().getFullYear();
        const monthlySales = await Payment_1.default.aggregate([
            {
                $match: {
                    paymentStatus: 'completed',
                    createdAt: {
...
exports.getMonthlySalesData = getMonthlySalesData;
// Get admin profit statistics
const getAdminProfits = async (req, res) => {
    try {
        // Get query parameters for filtering
        ...
        const payments = await Payment_1.default.find(matchConditions);
        ...
        const monthlyProfits = payments.reduce((acc, payment) => {
        ...
        const monthlyData = Object.values(monthlyProfits).sort((a, b) => a.month.localeCompare(b.month));
        // Get profits by payment method
        const profitsByMethod = payments.reduce((acc, payment) => {
...
exports.getAdminProfits = getAdminProfits;
// Get monthly admin profit data for charts
const getMonthlyAdminProfits = async (req, res) => {
    try {
        const { year } = req.query;
        const targetYear = year ? parseInt(year) : new Date().getFullYear();
        const monthlyProfits = await Payment_1.default.aggregate([
            {
                $match: {
                    paymentStatus: 'completed',
                    createdAt: {
...
exports.getMonthlyAdminProfits = getMonthlyAdminProfits;
